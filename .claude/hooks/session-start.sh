...
directive = (
    ...
    "3) Commit the data/ change and push it straight to master so GitHub Pages redeploys. "
    "Do NOT open a pull request for it — this is a sanctioned data-only refresh (CLAUDE.md), "
    "and a PR here just becomes stale the moment the next refresh lands.\n"
